      ...
      <div class="modal-body">
        ...
        <meta name="csrf-token" content="{{ csrf_token() }}" />
          <div class="form-group">
            ...
            <input type="text" name="name" id="name" value="" placeholder="Enter class name" class="code" required>
            @error('name')
...
$(document).on('click', '.edit', function(){
  ...
  edit_id=id;
  $('#form_result').html('');
// $('#myModal').on('click', '#editclass', function (event) {
