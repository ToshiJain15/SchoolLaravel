  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" id="citydata">
        <meta name="csrf-token" content="{{ csrf_token() }}" />
          <div class="form-group">
            <input type="hidden" id="city_id" name="id" value="{{$data->id}}">
            <label for="city-name" class="col-form-label">Name:</label>
            <input type="text" name="name" id="name" value="{{$data['name']}}" placeholder="Enter city name" class="code">
          </div>     
      </div>
...
$(document).on('click', '.edit', function(){
  ...
  edit_id=id;
  $('#form_result').html('');
// $('#myModal').on('click', '#editCity', function (event) {
